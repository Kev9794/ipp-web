...
const UDitch = () => {
  ...
  return (
    <div className="p-4 md:p-10 lg:p-20 bg-zinc-800">
      ...
      <p className="text-heading4 text-white mt-8">Ukuran Dimensi U-Ditch</p>
      <table className="min-w-full text-left text-xs mt-4">
      ...
      <p className="text-heading4 text-white mt-8">
        Ukuran Dimensi Cover U-Ditch
      </p>
      <table className="min-w-full text-left text-xs mt-4">
        <thead className="uppercase tracking-wider border-b-2 border-neutral-600 border-t bg-zinc-900">
          <tr>
        ...
        <tbody>
          ...
          <tr className="border-b border-neutral-600 hover:bg-neutral-600">
            ...
            <td className="px-3 md:px-6 py-2 md:py-4 border-x border-neutral-600"></td>
          </tr>
          <tr className="border-b border-neutral-600 hover:bg-neutral-600">
            <td className="px-3 md:px-6 py-2 md:py-4 border-x border-neutral-600">
              Cover U-Dicth LD 15.6
