            ...
            <tr className="border-b border-neutral-600 hover:bg-neutral-600">
              ...
              <td className="px-6 py-4 border-x border-neutral-600">
                <p className="text-justify">
                  Merupakan material pracetak yang sering digunakan di area
                  perumahan, dan juga untuk penahan tanah agar tidak tercecer ke
                  badan jalan, sehingga terlihat lebih rapi dan indah.
                  Sehubungan dengan jalanan dari paving, jenis kastin ini
                  berfungsi menjepit paving block agar tetap rapat di tempatnya
                  dan tidak bergeser. Ukuran kanstin taman lebih tipis dan lebih
                  rendah dibandingkan tinggi kanstin lainnya. Ukuran kanstin
                  taman yaitu 40 x 20 x 10 cm dengan isi per meter 2,5 pcs.
                </p>
              </td>
            </tr>
            <tr className="border-b border-neutral-600 hover:bg-neutral-600">
              ...
              <td className="px-6 py-4 border-x border-neutral-600">
                <p className="text-justify">
                  Berfungsi untuk memisahkan badan jalan dengan trotoar,
                  sehingga area pejalan kaki lebih tinggi dari pada area
                  kendaran. Ukuran kanstin trotoar yaitu 40 x 25 cm isi per
                  meter 2,5 pcs, dan 40 x 28 cm isi per meter 2,5 pcs.
                </p>
              </td>
            </tr>
            <tr className="border-b border-neutral-600 hover:bg-neutral-600">
              ...
              <td className="px-6 py-4 border-x border-neutral-600">
                <p className="text-justify">
                  Model kanstin S digunakan untuk menahan dan mengarahkan air ke
                  saluran pembuangan, memiliki tekstur bergelombang seperti tali
                  air memiliki ukuran 40 cm x 15 cm x 30 cm dengan nisi per
                  meter 2,5 pcs.
                </p>
              </td>
            </tr>
