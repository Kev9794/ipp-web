...
const BoxCulvert = () => {
  ...
  return (
    <div className="p-4 sm:p-14 bg-zinc-800">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full text-left text-xs whitespace-nowrap mt-8">
          ...
          <tbody>
            <tr className="border-b border-neutral-600 hover:bg-neutral-600">
              <td className="px-6 py-4 border-x border-neutral-600">4.4</td>
              <td className="px-6 py-4 border-x border-neutral-600">
                400 x 400 x 1000 mm
              </td>
              <td className="px-6 py-4 border-x border-neutral-600">90 mm</td>
              <td className="px-6 py-4 border-x border-neutral-600">90 mm</td>
              <td className="px-6 py-4 border-x border-neutral-600">483 kg</td>
            </tr>
            <tr className="border-b border-neutral-600 hover:bg-neutral-600">
              <td className="px-6 py-4 border-x border-neutral-600">5.5</td>
              <td className="px-6 py-4 border-x border-neutral-600">
                500 x 500 x 1000 mm
              </td>
              <td className="px-6 py-4 border-x border-neutral-600">100 mm</td>
              <td className="px-6 py-4 border-x border-neutral-600">100 mm</td>
              <td className="px-6 py-4 border-x border-neutral-600">657 kg</td>
            </tr>
            <tr className="border-b border-neutral-600 hover:bg-neutral-600">
              <td className="px-6 py-4 border-x border-neutral-600">6.6</td>
              <td className="px-6 py-4 border-x border-neutral-600">
                600 x 600 x 1000 mm
              </td>
              <td className="px-6 py-4 border-x border-neutral-600">110 mm</td>
              <td className="px-6 py-4 border-x border-neutral-600">100 mm</td>
              <td className="px-6 py-4 border-x border-neutral-600">773 kg</td>
            </tr>
            <tr className="border-b border-neutral-600 hover:bg-neutral-600">
              <td className="px-6 py-4 border-x border-neutral-600">8.8</td>
              <td className="px-6 py-4 border-x border-neutral-600">
                800 x 800 x 1000 mm
              </td>
              <td className="px-6 py-4 border-x border-neutral-600">120 mm</td>
              <td className="px-6 py-4 border-x border-neutral-600">100 mm</td>
              <td className="px-6 py-4 border-x border-neutral-600">1024 kg</td>
            </tr>
            <tr className="border-b border-neutral-600 hover:bg-neutral-600">
              <td className="px-6 py-4 border-x border-neutral-600">10.10</td>
              <td className="px-6 py-4 border-x border-neutral-600">
                1000 x 1000 x 1000 mm
              </td>
              <td className="px-6 py-4 border-x border-neutral-600">140 mm</td>
              <td className="px-6 py-4 border-x border-neutral-600">125 mm</td>
              <td className="px-6 py-4 border-x border-neutral-600">1560 kg</td>
            </tr>
          </tbody>
        </table>
      </div>
