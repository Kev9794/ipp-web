...
export default function Tambun() {
  const slides = [
    {
      url: "/image/projects/tambun.jpg",
    },
    {
      url: "/image/projects/tambun2.jpg",
    },
    {
      url: "/image/projects/tambun3.jpg",
    },
    {
      url: "/image/projects/tambun4.jpg",
    },
    {
      url: "/image/projects/tambun5.jpg",
    },
  ];
      ...
      <div className="flex flex-col p-14 bg-zinc-800">
        <div className="w-full flex flex-col justify-center items-center pb-8">
          <p className="text-title">
            Project <span className="text-red-600">Tambun</span>
          </p>
        </div>
