...
export default function TolSemarangDemak() {
  const slides = [
    {
      url: "/image/projects/tol_semarang_demak.jpg",
    },
    {
      url: "/image/projects/tol_semarang_demak2.jpg",
    },
    {
      url: "/image/projects/tol_semarang_demak4.jpg",
    },
    {
      url: "/image/projects/tol_semarang_demak5.jpg",
    },
  ];
      ...
      <div className="flex flex-col p-14 bg-zinc-800">
        <div className="w-full flex flex-col justify-center items-center pb-8">
          <p className="text-title">
            Project Tol <span className="text-red-600">Semarang-Demak</span>
          </p>
        </div>
